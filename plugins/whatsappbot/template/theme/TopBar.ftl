...
<#case "spark"><path d="M12 3l1.8 4.9L19 9.7l-5.2 1.8L12 16.4l-1.8-4.9L5 9.7l5.2-1.8z"/><path d="M19 15l.8 2.2L22 18l-2.2.8L19 21l-.8-2.2L16 18l2.2-.8z"/><#break>
...
<aside class="ms-sidebar" id="msSidebar">
  ...
  <nav>
    <#if (isWaAdmin!"N") != "Y" || currentTenantId?has_content>
      ...
      <@nav "AiAgent" "AI Agent" "spark" "AiAgent"/>
