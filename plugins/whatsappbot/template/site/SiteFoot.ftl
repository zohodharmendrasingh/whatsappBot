<footer class="s-footer">
  <div class="s-wrap s-footer-in">
    <div>
      <img src="/theme/flochat-logo.svg" alt="FloChat" height="34"/>
      <p>No-code WhatsApp chatbots, team inbox,<br/>broadcasts and APIs.</p>
    </div>
    <div>
      <h4>Product</h4>
      <a href="<@ofbizUrl>home</@ofbizUrl>#features">Features</a>
      <a href="<@ofbizUrl>home</@ofbizUrl>#pricing">Pricing</a>
      <a href="<@ofbizUrl>signup</@ofbizUrl>">Start free trial</a>
    ...
    <div>
      ...
      <a href="<@ofbizUrl>data-deletion</@ofbizUrl>">Data Deletion</a>
    </div>
    <div>
      <h4>Contact</h4>
